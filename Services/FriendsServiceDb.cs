...
public class FriendsServiceDb : IFriendsService
{
    ...
    public Task<ResponsePageDto<IFriend>> ReadFriendsAsync(bool seeded, bool flat, string? country, string? city, string filter, int pageNumber, int pageSize) => _repo.ReadFriendsAsync(seeded, flat, country, city, filter, pageNumber, pageSize);
